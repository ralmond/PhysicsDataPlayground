...
The raw JSON data is available at [PPIES2022-AllP4Events.json.gz](Data/PPIES2022-AllP4Events.json.gz).

The filtered data containing only “interesting” events is at [PPIES2022-P4Filtered.json.gz](Data/PPIES2022-P4Filtered.json.gz).
